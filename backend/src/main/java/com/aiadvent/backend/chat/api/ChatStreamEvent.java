...
public record ChatStreamEvent(
  ...
  public static ChatStreamEvent session(
    ...
    return new ChatStreamEvent(sessionId, "session", null, newSession, provider, model, null, null, null);
  }

  public static ChatStreamEvent token(UUID sessionId, String content, String provider, String model) {
    return new ChatStreamEvent(sessionId, "token", content, false, provider, model, null, null, null);
  }
  ...
  public static ChatStreamEvent complete(
      ...
      UsageCostDetails cost,
      String usageSource) {
    return new ChatStreamEvent(sessionId, "complete", content, false, provider, model, usage, cost, usageSource);
  }

  public static ChatStreamEvent error(UUID sessionId, String content, String provider, String model) {
    return new ChatStreamEvent(sessionId, "error", content, false, provider, model, null, null, null);
  }
}
