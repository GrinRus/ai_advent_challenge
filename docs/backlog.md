...
- [x] Спроектировать базовую админ-панель (можно отдельным route) для управления ролями: таблица профилей, фильтры по namespace, действия “назначить роль”, “убрать роль”, просмотр истории. Зафиксировать, что доступ к панели ограничен ролью `admin`.  
